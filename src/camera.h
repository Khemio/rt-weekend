...
class camera {
    public:
        ...
        point3 lookat = point3(0,0,-1);  // Pont camera is lookinf at
        vec3 vup = vec3(0,1,0); // Camera relative up direction

        double defocus_angle = 0; // Variation anglr of rayse through each pixel
    ...
    private:
        ...
        vec3 defocus_disk_u;   // Defocus disc horizontal radius
        vec3 defocus_disk_v;   // Defocus disc vertical radius
